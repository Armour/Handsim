...
def R_type(line):
    if R_dict[line[-6:]][0] == 0:
        return R_dict[line[-6:]][1] + ' ' + code[line[16:21]] + \
            ', ' + code[line[6:11]] + ', ' + code[line[11:16]]
        ...
        return R_dict[line[-6:]][1] + ' ' + code[line[16:21]] + \
            ', ' + code[line[11:16]] + ', ' + code[line[6:10]]
    elif R_dict[line[-6:]][0] == 4:
        return R_dict[line[-6:]][1] + ' ' + code[line[16:21]] + \
            ', ' + code[line[11:16]] + ', ' + str(int(line[21:26], 2))
    elif R_dict[line[-6:]][0] == 5:
        return R_dict[line[-6:]][1] + ' ' + code[line[16:21]]
    elif R_dict[line[-6:]][0] == 6:
        return R_dict[line[-6:]][1] + ' ' + \
            code[line[16:21]] + ', ' + code[line[6:11]]
...
def I_type(line, PC):
    if I_dict[line[0:6]][0] == 0:
        return I_dict[line[0:6]][1] + ' ' + code[line[11:16]] + \
            ', ' + str(int(line[16:], 2)) + '(' + code[line[6:11]] + ')'
    elif I_dict[line[0:6]][0] == 1:
        return I_dict[line[0:6]][1] + ' ' + code[line[6:11]] + \
            ', ' + 'mark_' + str(handle(line[16:], PC / 4))
    elif I_dict[line[0:6]][0] == 2:
        return I_dict[line[0:6]][1] + ' ' + code[line[6:11]] + ', ' + \
            code[line[11:16]] + ', mark_' + str(handle(line[16:], PC / 4))
    elif I_dict[line[0:6]][0] == 3:
        return I_dict[line[0:6]][1] + ' ' + code[line[11:16]] + \
            ', ' + code[line[6:11]] + ', ' + str(int(line[16:], 2))
    elif I_dict[line[0:6]][0] == 4:
        return I_dict[line[0:6]][1] + ' ' + \
            code[line[11:16]] + ', ' + code[line[6:11]]
